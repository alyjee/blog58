...
class UmrahForm extends Model
{
    ...
    protected $fillable = ['id', 'ref_num', 'person_name', 'total_passengers', 'total_days', 'from_date', 'to_date', 'adults', 'childs', 'infants', 'package_category', 'transport', 'archive', 'created_at', 'updated_at', 'stage', 'adult_ticket_price', 'child_ticket_price', 'infant_ticket_price', 'total_ticket_price', 'umrah_per_person', 'total_umrah_price', 'total_package_price', 'total_package_price_pkr', 'airline', 'flight_type', 'psf', 'transport_charges', 'visa_charges', 'all_iternaries_total', 'conversion_rate'];
