<div class="row airline-details">
    <div class="text-left col-sm-1">
        <div class="form-group">
            ...
            <button type="button" class="btn btn-danger remove-flight-detail">X</button>
        </div>
    </div>
    ...
    <div class="col-sm-1">
        <div class="form-group form-group {{ $errors->has('day') ? ' has-error' : '' }}">
            {!! Form::label('day', 'Day') !!}
            {!! Form::text('day[]', (isset($day)) ? $day : null, ['placeholder'=>'Day', 'class'=>'form-control flight-day day', 'readonly'=>'readonly']) !!}
            @if ($errors->has('day'))
    ...
    <div class="col-sm-2">
        <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('date[]', (isset($date)) ? $date : null, ['placeholder'=>'Date', 'class'=>'form-control mydatepicker flight-date date']) !!}
            @if ($errors->has('date'))
    ...
    <div class="col-sm-1">
        <div class="form-group {{ $errors->has('flight_status') ? ' has-error' : '' }}">
            ...
            {!! Form::select('flight_status[]', $flightStatusSelect, (isset($flight_status)) ? $flight_status : null,  ['placeholder'=>'Select Flight Status', 'class'=>'form-control flight_status']) !!}
    ...
    <div class="col-sm-2">
        <div class="form-group {{ $errors->has('city_terminal_stopover') ? ' has-error' : '' }}">
            ...
            {!! Form::textarea('city_terminal_stopover[]', (isset($city_terminal_stopover)) ? $city_terminal_stopover : null, ['placeholder'=>'', 'rows'=>'1', 'class'=>'form-control city_terminal_stopover']) !!}
    ...
    <div class="col-sm-1">
        <div class="form-group {{ $errors->has('time') ? ' has-error' : '' }}">
            ...
            {!! Form::text('time[]', (isset($time)) ? $time : null, ['placeholder'=>'Time', 'class'=>'form-control time']) !!}
            @if ($errors->has('time'))
    ...
    <div class="col-sm-2">
        <div class="form-group {{ $errors->has('flight_class_status') ? ' has-error' : '' }}">
            ...
            {!! Form::textarea('flight_class_status[]', (isset($flight_class_status)) ? $flight_class_status : null, ['placeholder'=>'', 'rows'=>'1', 'class'=>'form-control flight_class_status']) !!}
    ...
    <div class="col-sm-2">
        <div class="form-group {{ $errors->has('stop_eqp_flts') ? ' has-error' : '' }}">
            ...
            {!! Form::textarea('stop_eqp_flts[]', (isset($stop_eqp_flts)) ? $stop_eqp_flts : null, ['placeholder'=>'', 'rows'=>'1', 'class'=>'form-control stop_eqp_flts']) !!}
