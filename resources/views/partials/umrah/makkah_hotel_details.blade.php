<div class="row">
    <div class="col-sm-6">
        <div class="form-group {{ $errors->has('makkah_from_date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('makkah_from_date', null,['placeholder'=>'From Date', 'class'=>'form-control mydatepicker pricing-input']) !!}
    ...
    <div class="col-sm-6">
        <div class="form-group {{ $errors->has('makkah_to_date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('makkah_to_date', null,['placeholder'=>'To Date', 'class'=>'form-control mydatepicker pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('makkah_hotel_nights') ? ' has-error' : '' }}">
    ...
    {!! Form::number('makkah_hotel_nights', null,['placeholder'=>'Enter Nights in Makkah Hotel', 'class'=>'form-control pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('makkah_hotel') ? ' has-error' : '' }}">
    ...
    {!! Form::select('makkah_hotel', $hotelSelect, null, ['placeholder'=>'Select Hotel For Makkah', 'class'=>'form-control pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('makkah_hotel_distance_from_haram') ? ' has-error' : '' }}">
    {!! Form::label('makkah_hotel_distance_from_haram', 'Haram Distance') !!}
    {!! Form::text('makkah_hotel_distance_from_haram', null,['class'=>'form-control', 'readonly'=>'readonly']) !!}
    @if ($errors->has('makkah_hotel_distance_from_haram'))
        <div class="form-control-feedback">{{ $errors->first('makkah_hotel_distance_from_haram') }}</div>
    @endif
</div>
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_double_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_double_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_double_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_triple_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_triple_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_triple_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_quad_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_quad_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_quad_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_quint_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_quint_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_quint_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_sharing_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_sharing_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_sharing_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_weekend_price_div">
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_weekend_price_price') ? ' has-error' : '' }}">
        ...
        {!! Form::text('makkah_weekend_price_price', null,['placeholder'=>'', 'class'=>'form-control pricing-input', 'readonly'=>'readonly']) !!}
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_weekend_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_weekend_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_haram_view_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_haram_view_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_haram_view_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_full_board_per_pax_per_day_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_full_board_per_pax_per_day_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_full_board_per_pax_per_day_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_four_nights_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_four_nights_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_four_nights_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row makkah-feature-div {{$featureclass}}" id="makkah_extra_bed_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('makkah_extra_bed_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('makkah_extra_bed_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
