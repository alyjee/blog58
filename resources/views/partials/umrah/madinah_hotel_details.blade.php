<div class="row">
    <div class="col-sm-6">
        <div class="form-group {{ $errors->has('madinah_from_date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('madinah_from_date', null,['placeholder'=>'From Date', 'class'=>'form-control mydatepicker pricing-input']) !!}
    ...
    <div class="col-sm-6">
        <div class="form-group {{ $errors->has('madinah_to_date') ? ' has-error' : '' }}">
            ...
            {!! Form::text('madinah_to_date', null,['placeholder'=>'To Date', 'class'=>'form-control mydatepicker pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('madinah_hotel_nights') ? ' has-error' : '' }}">
    ...
    {!! Form::number('madinah_hotel_nights', null,['placeholder'=>'Enter Nights in Madinah Hotel', 'class'=>'form-control pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('madinah_hotel') ? ' has-error' : '' }}">
    ...
    {!! Form::select('madinah_hotel', $hotelSelect, null, ['placeholder'=>'Select Madinah Hotel', 'class'=>'form-control pricing-input']) !!}
...
<div class="form-group form-group {{ $errors->has('madinah_hotel_distance_from_haram') ? ' has-error' : '' }}">
    {!! Form::label('madinah_hotel_distance_from_haram', 'Haram Distance') !!}
    {!! Form::text('madinah_hotel_distance_from_haram', null,['class'=>'form-control', 'readonly'=>'readonly']) !!}
    @if ($errors->has('madinah_hotel_distance_from_haram'))
        <div class="form-control-feedback">{{ $errors->first('madinah_hotel_distance_from_haram') }}</div>
    @endif
</div>
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_double_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_double_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_double_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_triple_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_triple_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_triple_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_quad_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_quad_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_quad_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_quint_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_quint_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_quint_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_sharing_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_sharing_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_sharing_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_weekend_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_weekend_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_weekend_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_haram_view_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_haram_view_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_haram_view_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_full_board_per_pax_per_day_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_full_board_per_pax_per_day_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_full_board_per_pax_per_day_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_four_nights_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_four_nights_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_four_nights_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
...
<div class="row madinah-feature-div {{$featureclass}}" id="madinah_extra_bed_price_div">
    ...
    <div class="form-group form-group col-sm-6 {{ $errors->has('madinah_extra_bed_price_qty') ? ' has-error' : '' }}">
        ...
        {!! Form::number('madinah_extra_bed_price_qty', null,['placeholder'=>'', 'class'=>'form-control pricing-input']) !!}
